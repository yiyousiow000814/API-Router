...
export const devStatus: Status = {
  ...
  client_sessions: [
    ...
    },
    {
      ...
      agent_parent_session_id: '019c4578-0f3c-7f82-a4f9-b41a1e65e242',
      reported_model_provider: 'api_router',
      reported_model: 'gpt-5.2',
    ...
    },
    {
      ...
      agent_parent_session_id: '019c03fd-6ea4-7121-961f-9f9b64d2c1b5',
      reported_model_provider: 'api_router',
      reported_model: 'gpt-5.2',
      reported_base_url: 'http://172.26.144.1:4000/v1',
    ...
    peers: [
      {
        ...
        sync_diagnostics: [
          ...
          },
          {
            ...
            status: 'blocked',
            local_contract_version: 4,
            peer_contract_version: 1,
            blocked_reason:
              'Rejected LAN usage_history sync from Desk B because sync contract version does not match (local=v4, peer=v1). Update both devices to the same compatible build. Sync will resume automatically once versions match.',
          },
        ],
