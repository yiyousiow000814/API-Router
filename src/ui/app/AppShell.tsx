      ...
      <div className="aoScale">
        <div className="aoShell" ref={contentRef}>
          ...
          {activePage === 'usage_statistics' ? (
            <UsageStatisticsPage
              config={config}
              fmtKpiTokens={fmtKpiTokens}
              fmtPricingSource={fmtPricingSource}
              fmtUsdMaybe={fmtUsdMaybe}
              fmtUsageBucketLabel={fmtUsageBucketLabel}
              fmtWhen={fmtWhen}
              openUsageScheduleModal={openUsageScheduleModal}
              providerPreferredCurrency={providerPreferredCurrency}
              providerTotalUsedDisplayUsd={providerTotalUsedDisplayUsd}
              ...
              usageActiveWindowHours={usageActiveWindowHours}
              usageAnomalies={usageAnomalies}
              usageAvgRequestsPerHour={usageAvgRequestsPerHour}
              usageAvgTokensPerHour={usageAvgTokensPerHour}
              usageAvgTokensPerRequest={usageAvgTokensPerRequest}
              ...
              usagePricedCoveragePct={usagePricedCoveragePct}
              usagePricedRequestCount={usagePricedRequestCount}
              ...
              usageTopModel={usageTopModel}
              usageTotalInputTokens={usageTotalInputTokens}
              usageTotalOutputTokens={usageTotalOutputTokens}
            ...
            <ProviderSwitchboardPage
              ...
              setProviderSwitchTarget={setProviderSwitchTarget}
              switchboardModeLabel={switchboardModeLabel}
              switchboardModelProviderLabel={switchboardModelProviderLabel}
              switchboardProviderCards={switchboardProviderCards}
              switchboardTargetDirsLabel={switchboardTargetDirsLabel}
            />
          ) : !status ? (
            ...
            <DashboardPage
              ...
              override={override}
              overrideDirtyRef={overrideDirtyRef}
              providers={providers}
              refreshingProviders={refreshingProviders}
              refreshQuota={refreshQuota}
              refreshStatus={refreshStatus}
              resolveCliHomes={resolveCliHomes}
              setCodexRefreshing={setCodexRefreshing}
              setCodexSwapModalOpen={setCodexSwapModalOpen}
              ...
              setSessionPreferred={setSessionPreferred}
              status={status}
