...
type Props = {
  activePage: TopPage
  onSwitchPage: (page: TopPage) => void
  onOpenInstruction: () => void
}

export function AppHeader({ activePage, onSwitchPage, onOpenInstruction }: Props) {
  return (
    <div className="aoBrand">
      ...
      <div className="aoBrandRight">
        ...
        <button className="aoTinyBtn" aria-label="Getting Started" onClick={onOpenInstruction}>
          Getting Started
        </button>
      </div>
    </div>
