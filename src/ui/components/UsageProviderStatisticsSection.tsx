...
export function UsageProviderStatisticsSection({
  ...
  return (
    <div className="aoUsageProviderCard">
      <div className="aoSwitchboardSectionHead aoUsageProviderSectionHead">
        <div className="aoMiniLabel">Provider Statistics</div>
        <div className="aoUsageProviderHeaderActions">
          <div className="aoHint aoUsageProviderHeaderHint">
            Includes tok/req, $/M tokens, est/day (16h projection), and selected-window total used cost.
          </div>
          <div className="aoUsageProviderHeaderButtons">
