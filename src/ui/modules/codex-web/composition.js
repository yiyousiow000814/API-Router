export function createCodexWebComposition(deps) {
  ...
  const { addHost, clearQueuedTurn, editQueuedTurn, executeSlashCommand, flushQueuedTurn, interruptTurn, newThread, queueFollowUpTurn, resolveApproval, resolveUserInput, sendNowTurn, sendQueuedTurnNow, sendTurn, steerTurn, uploadAttachment, removePendingAttachment, previewPendingAttachment } =
    turnActions;
